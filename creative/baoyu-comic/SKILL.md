...
This skill is part of the **Baoyu visual content creation family** from [baoyu-skills](https://github.com/JimLiu/baoyu-skills). Sibling skills are absorbed as reference files:

| Absorbed Skill | File | Covers |
|----------------|------|--------|
| baoyu-article-illustrator | `references/baoyu-article-illustrator.md` | Article illustrations: type × style × palette consistency. Use for blog posts, editorial content, and social media graphics. |
| baoyu-infographic | `references/baoyu-infographic.md` | Professional infographics with 21 layout types and 21 visual styles. Use for "infographic", "visual summary", "信息图". |
